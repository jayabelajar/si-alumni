    ...
    <div class="container px-4">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-5 mb-lg-0">
                ...
                <p class="text-muted fs-5 mb-5 lh-lg">Portal terpadu untuk menjalin networking, berbagi informasi
                    lowongan kerja, dan melacak kesuksesan karir lulusan kami.</p>
                <div class="d-flex flex-column flex-md-row gap-3">
                    <a href="/login" class="btn btn-primary btn-lg px-5 rounded-pill shadow-sm fw-bold py-3">Mulai
                        Sekarang</a>
                    <a href="#features"
                        class="btn btn-outline-light btn-lg px-5 rounded-pill text-dark border-0 shadow-none fw-bold py-3">Pelajari
                        Lebih Lanjut</a>
                </div>
            </div>
            <div class="col-lg-6 text-center">
                <div class="position-relative">
                    <img src="https://images.unsplash.com/photo-1521737711867-e3b97375f902?q=80&w=600&auto=format&fit=crop"
                        class="img-fluid hero-image shadow-lg" alt="Alumni">
                    <div
                        class="position-absolute bottom-0 start-0 bg-white p-4 rounded-4 shadow-lg m-4 d-none d-md-block text-start border border-light">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card feature-card h-100 p-4 border-0 shadow-sm overflow-hidden">
                    <div class="card-body p-2">
                        ...
                        <p class="text-muted mb-0 leading-relaxed">Akses eksklusif ke lowongan kerja dari perusahaan
                            mitra yang mencari talenta terbaik dari kampus kami.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="card feature-card h-100 p-4 border-0 shadow-sm overflow-hidden">
                    <div class="card-body p-2">
                        ...
                        <p class="text-muted mb-0 leading-relaxed">Jalin kembali komunikasi dan kolaborasi profesional
                            dengan ribuan alumni di berbagai sektor industri.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="card feature-card h-100 p-4 border-0 shadow-sm overflow-hidden">
                    <div class="card-body p-2">
                        ...
                        <p class="text-muted mb-0 leading-relaxed">Sistem pelacakan karir yang efisien untuk membantu
                            institusi meningkatkan standar kualitas pendidikan.</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-5 mt-5">
    <div class="bg-dark rounded-5 p-5 text-center text-white shadow-lg overflow-hidden position-relative">
        <div class="position-relative z-1">
            ...
            <a href="/login" class="btn btn-primary btn-lg px-5 rounded-pill fw-bold py-3 shadow-lg">Login ke Portal
                Sekarang</a>
        </div>
    </div>
</section>
